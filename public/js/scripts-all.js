    ...
    $(document).ready(function () {
        ...
        */
        ...
        $('#formLogin').submit(function (e) {
            ...
            }, _defineProperty(_$$ajax, 'dataType', "json"), _defineProperty(_$$ajax, 'type', 'POST'), _defineProperty(_$$ajax, 'cache', false), _defineProperty(_$$ajax, 'beforeSend', function beforeSend() {
            ...
            }), _defineProperty(_$$ajax, 'error', function error(xhr, status, _error) {
                if (status == 'error') {
                    if (xhr.status == 500) {
        ...
        $('#formRegister').submit(function (e) {
            ...
            $.ajax({
                ...
                error: function error(xhr, status, _error2) {
                    ...
                    if (status == 'error') {
                        responsetMsg(formTextVal, 'alert-warning alert-success', 'alert-danger', 'Error: No communication with API server.');
                    }
                },
